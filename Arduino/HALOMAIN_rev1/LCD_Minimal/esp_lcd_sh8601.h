...
/** SPI panel IO trans queue depth (safer under scroll/animation load) */
#define SH8601_PANEL_IO_SPI_TRANS_QUEUE_DEPTH  8
/** QSPI panel IO trans queue depth (safer under scroll/animation load) */
#define SH8601_PANEL_IO_QSPI_TRANS_QUEUE_DEPTH 8
...
#define SH8601_PANEL_IO_SPI_CONFIG(cs, dc, cb, cb_ctx)          \
    {                                                           \
        ...
        .trans_queue_depth = SH8601_PANEL_IO_SPI_TRANS_QUEUE_DEPTH, \
...
#define SH8601_PANEL_IO_QSPI_CONFIG(cs, cb, cb_ctx)             \
    {                                                           \
        ...
        .spi_mode = 0,                                          \
        .pclk_hz = 40 * 1000 * 1000,                            \
        .trans_queue_depth = SH8601_PANEL_IO_QSPI_TRANS_QUEUE_DEPTH, \
        .on_color_trans_done = cb,                              \
        .user_ctx = cb_ctx,                                     \
        .lcd_cmd_bits = 32,                                     \
        .lcd_param_bits = 8,                                    \
